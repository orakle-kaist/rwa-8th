// 투자자 시연은 1차 발행부터 환매까지 같은 합성 삼성전자 권리를 사용한다.
// 990002 계약은 가격·위험 회귀시험용 배포 자산으로만 남고 제품 API에는 노출하지 않는다.
export const LOCAL_SECONDARY_SECURITY_ID = "990001";
export const LOCAL_SECONDARY_NAME = "모의 삼성전자 수탁권리";
export const LOCAL_SECONDARY_SYMBOL = "SIM990001";
export const LOCAL_SECONDARY_DEPLOYMENT_KEY = "TEST00000001";
export const LOCAL_SECONDARY_REFERENCE_SECURITY_ID = "005930";
export const LOCAL_SECONDARY_REFERENCE_KRW = 257_000n;
export const LOCAL_SECONDARY_REFERENCE_USD_MINOR = 18_619n;
export const LOCAL_SECONDARY_NORMAL_ASK_USD_MINOR = 18_712n;
export const LOCAL_SECONDARY_NORMAL_ASK_USDC_MINOR = 187_120_000n;
export const LOCAL_SECONDARY_REGRESSION_SECURITY_ID = "990002";
