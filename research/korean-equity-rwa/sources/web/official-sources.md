...
검증 기준일은 2026-08-23이다. `A`는 법령·감독기관·공식 표준·직접 감사 가능한 1차 자료, `B`는 공식 기관의 설명 또는 기업 약관이다. 아래 요약은 원문의 대체물이 아니며 실제 사업화 시 최신 원문과 법률의견을 다시 확인해야 한다.
...
| S003 | A | [국가법령정보센터, 개정 전자증권법](https://law.go.kr/LSW/lsInfoP.do?lsiSeq=283195&viewCls=lsRvsDocInfoR) | 2027년 2월 4일 시행 예정. 전자등록기관과 계좌관리기관의 분산원장 이용, 발행인계좌관리기관 등록, 분산원장과 연계장부의 결합, 총량관리와 일반 전자등록증권 사이의 전환 절차를 마련. 증권시장 상장은 분산원장등록주식을 일반 전자등록주식으로 전환할 수 있는 사유 중 하나 | 2단계 법정 장부형 레일의 참여방식, 데이터 분리와 기존 상장주식 적용 한계를 구분 |
...
- S003~S005는 분산원장 기록에 법적 효력이 생기는 경로를 보여준다. 1단계는 수탁주식에 대한 계약상 권리로 다루고, 2단계는 기존 전자등록기관과 계좌관리기관 또는 등록된 발행인계좌관리기관이 참여하는 법적 증권 계좌부로 구분한다. 법정 장부는 분산원장과 연계장부를 함께 사용할 수 있으므로 모든 정보를 원장에 직접 공개한다고 해석하지 않는다. 증권시장 상장이 일반 전자등록주식으로 전환할 수 있는 사유로 규정된 점을 고려해 기존 상장주식의 적용과 시장 인프라는 하위규정과 참여기관 준비를 확인해야 한다.
