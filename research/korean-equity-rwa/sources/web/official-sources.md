...
검증 기준일은 2026-08-22이다. `A`는 법령·감독기관·공식 표준·직접 감사 가능한 1차 자료, `B`는 공식 기관의 설명 또는 기업 약관이다. 아래 요약은 원문의 대체물이 아니며 실제 사업화 시 최신 원문과 법률의견을 다시 확인해야 한다.
...
| S045 | A | [국가법령정보센터, 현행 전자증권법](https://www.law.go.kr/LSW/lsInfoP.do?ancYnChk=0&lsId=012514) | 전자등록계좌부의 구성과 전자등록의 정의, 계좌 간 대체 절차, 전자등록계좌부에 기록된 권리자의 추정과 양도 효력을 규정 | 현행 제도에서 토큰 이전만으로 기초 한국주식의 권리가 이전되지 않는 이유와 1단계 기준 장부를 설명 |
...
- S045는 현행 전자등록주식의 권리이전 기준이다. 수탁 권리 토큰의 이전을 전자등록계좌부의 계좌 간 대체와 같은 법적 행위로 보지 않는다.
