...
검증 기준일은 2026-08-20이다. `A`는 법령·감독기관·공식 표준·직접 감사 가능한 1차 자료, `B`는 공식 기관의 설명 또는 기업 약관이다. 아래 요약은 원문의 대체물이 아니며 실제 사업화 시 최신 원문과 법률의견을 다시 확인해야 한다.
...
| S003 | A | [국가법령정보센터, 개정 전자증권법](https://law.go.kr/LSW/lsInfoP.do?lsiSeq=283195&viewCls=lsRvsDocInfoR) | 2027년 2월 4일 시행 예정. 전자등록기관과 계좌관리기관의 분산원장 이용, 발행인계좌관리기관 등록, KSD 총량관리와 일반 전자등록증권 사이의 전환 절차를 마련 | 2단계 법정 장부형 네이티브 토큰 레일의 법적 출발점과 참여방식 구분 |
| S004 | A | [금융위원회, 토큰증권 법률 개정안 통과 설명](https://www.fsc.go.kr/po010105/86064) | 분산원장을 증권 계좌부로 이용할 수 있으나 토큰은 증권의 형식이므로 자본시장법상 금융투자업 인가, 공시와 투자자 보호 규제가 그대로 적용됨 | 새로운 토큰 레일과 규제 우회를 구분하는 기준 |
| S005 | A | [금융위원회, 토큰증권 협의체 제2차 회의](https://www.fsc.go.kr/no010101/86906) | 시행일 2027-02-04 예정. 기존 주식·채권·MMF의 토큰화와 온체인 결제는 테스트와 인프라 개선을 포함한 단계별 로드맵으로 준비 | 개정법만으로 기존 상장주식 토큰화가 즉시 상용화된다고 주장하지 않음 |
...
| S040 | A | [국가법령정보센터, 자본시장법 제11조와 제12조](https://www.law.go.kr/LSW/lsLawLinkInfo.do?chrClsCd=010202&lsId=010513&lsJoLnkSeq=900295097&print=print) | 무인가 금융투자업을 금지하고 인가업무를 금융투자업 종류, 상품 범위와 투자자 유형으로 구분 | 네거티브 상품 규율이 무인가 매매와 중개를 허용한다는 해석 배제 |
| S041 | A | [금융위원회, 자본시장 인프라 혁신 점검회의](https://www.fsc.go.kr/po010106/87166) | 2026년 6월 23일 기준 T+1, 거래시간 연장, 토큰증권 인프라와 실시간·상시거래·통합 디지털 시장 전환을 연계해 검토 | 2단계를 규제 밖 우회가 아니라 제도권 인프라 전환 과제로 설명 |

## 소스별 해석 제한

- S001·S002는 통합계좌가 모든 국가와 투자자에게 가장 좋은 경로이거나 토큰 수요가 입증됐다는 뜻이 아니다. 개인, 중소기관과 대형기관을 별도 법정 경로로 구분하지도 않는다. 해외 판매기관 참여, 시스템 연동, 고객확인과 권리배정은 계속 필요하다. S001은 상임대리인이 토큰 계약의 책임주체가 되거나 수탁은행이어야 한다고 정하지 않는다. 수탁은행이 상임대리인을 겸하는 것은 PoC의 기준 설계다.
- S003~S005는 분산원장 기록에 법적 효력이 생길 경로를 보여주지만, 현재 1단계 수탁 권리 토큰이 상장주식 자체라는 결론을 지지하지 않는다. 2027년 시행만으로 모든 기존 상장주식이 네이티브 토큰으로 전환되거나 발행회사 직접형만 허용된다고 단정할 수도 없다. 적용 대상과 시장 인프라는 하위규정과 참여기관 준비를 확인해야 한다.
