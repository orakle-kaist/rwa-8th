...
`research/korean-equity-rwa/sources/user/`는 팀원이 제공한 변경 금지 원본 영역이다. 아래 체크섬은 2026-08-23 재확인한 SHA-256이며, 이 문서는 원본의 위치와 설계 반영 여부를 감사할 수 있게 한다. 팀 문서는 유용한 선행조사이지만 공식 법령·감독자료·표준과 충돌할 경우 후자를 우선한다.
...
2. **전자등록주식 대 수탁 권리**: 1단계는 법적 주식 자체가 아니라 인가된 해외 증권사의 고객계좌에 기록되는 수익적 또는 수탁상 권리다. 2단계에서만 전자등록기관, 계좌관리기관 또는 등록된 발행인계좌관리기관이 참여하는 법적 증권 계좌부를 전제한다.
