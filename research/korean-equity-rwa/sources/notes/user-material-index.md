...
7. **Dinari 발행시점**: 공식 제품문서는 브로커 주문 체결 완료 통지 후 발행을 설명한다. 본 PoC도 체결분을 즉시 발행하되 국내 결제 대기 수량, 위험 부담 기관과 보증한도를 별도로 추적한다. Dinari와 Alpaca의 비공개 손실배분을 한국형에 존재한다고 가정하지 않는다.
