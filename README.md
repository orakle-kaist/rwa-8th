...
| 10. PoC 구현 | 구현 검토 완료, 승인 대기 | [구현 안내](docs/10-poc-implementation/IMPLEMENTATION_GUIDE.md), [구현 정합성 검토](docs/10-poc-implementation/IMPLEMENTATION_REVIEW.md), [로컬 인수시험 증거](docs/10-poc-implementation/LOCAL_ACCEPTANCE_EVIDENCE.md), [Fuji 배포 증거](docs/10-poc-implementation/FUJI_DEPLOYMENT_EVIDENCE.md)와 기능별 구현 증거 | 실제 PostgreSQL·Anvil·모의 기관 서명으로 연결된 로컬 생애주기와 Fuji 온체인 통제 결과를 검토할 때 |
