...
> 현재 상태: **6단계 검토 대기: 시스템 구조, 기술 선택과 보안 설계**
>
> 다음 행동: Fuji, ERC-3643 기반 제한형 토큰, USD와 USDC 정산, 외부 정보 전달, 권한과 키 및 개인정보 보호 설계가 승인된 1~5단계를 바꾸지 않는지 검토하고 승인한다.
>
...
| 6. 시스템 구조와 보안 | 검토 대기 | [시스템 구조](docs/06-architecture-security/ARCHITECTURE.md), [기술 선택](docs/06-architecture-security/TECHNOLOGY_DECISIONS.md), [보안과 개인정보](docs/06-architecture-security/SECURITY_AND_PRIVACY.md) | 구성요소, 토큰과 체인 및 외부정보, 권한과 키, 개인정보와 위협 통제를 확인할 때 |
...
- 6단계 문서는 팀 내부 검토안이다. 세 문서를 함께 승인하기 전에는 7단계를 시작하지 않는다.
