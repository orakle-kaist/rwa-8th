...
> 현재 상태: **6단계 승인 완료, 7단계 데이터와 연계 설계 착수 가능**
>
> 다음 행동: 승인된 1~6단계를 기준으로 공통 데이터, API, 시스템 이벤트와 오류 응답을 설계한다.
>
...
| 7. 데이터와 연계 | 착수 가능 | `docs/07-data-api-events/` 예정 | 공통 데이터, API와 이벤트를 설계할 때 |
