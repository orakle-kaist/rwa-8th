...
> 현재 상태: **8단계 승인 완료, 9단계 테스트 설계 착수 가능**
>
> 다음 행동: 승인된 요구사항, 상태, API, 계약 인터페이스와 불변식을 기준으로 9단계 테스트 범위와 합격조건을 확정한다.
>
...
| 9. 테스트 설계 | 착수 가능 | `docs/09-test-design/` 예정 | 구현 전 인수 및 실패 시험을 확정할 때 |
